    ...
    <div class="content">
        ...
        <div class="grid grid-cols-12 gap-6">
            ...
            <div class="col-span-12 lg:col-span-8 xxl:col-span-9">
                ...
                <form action="{{route('reset-password-code')}}" method="POST">
                    @csrf
                        ...
                        <div class="p-5">
                            <div>
                                <div class="input-form mt-3 @error('phone') has-error @enderror">
                                    ...
                                    <input id="validation-form-1"  type="text" value="{{auth()->user()->phone}}" name="phone" class="form-control" placeholder="09121234567"  required="">
