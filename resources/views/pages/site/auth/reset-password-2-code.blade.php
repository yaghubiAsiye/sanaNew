                        ...
                        <div class="p-5">
                            <div>
                                <div class="input-form mt-3 @error('code') has-error @enderror">
                                    <label for="validation-form-1" class="form-label w-full flex flex-col sm:flex-row">  کد ارسالی  <span class="sm:mr-auto mt-1 sm:mt-0 text-xs text-gray-600"> الزامی است   </span> </label>
                                    <input id="validation-form-1" value="{{old('code')}}" type="text"  name="code" class="form-control"   required="">
