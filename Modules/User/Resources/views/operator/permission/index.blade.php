...
<div class="flex">
    ...
    <div class="content">
        <!-- BEGIN: Top Bar -->
        @include('partials.topBarSide', ['breadcrumb'=> [' سطوح دسترسی']])
        <!-- END: Top Bar -->
        ...
        <div class="grid grid-cols-12 gap-6 mt-5">
            <div class="intro-y col-span-12 flex flex-wrap sm:flex-nowrap items-center mt-2">
                <a href="{{ route('Operator.Permission.create') }}" class="btn btn-primary shadow-md ml-2">افزودن  سطح دسترسی جدید</a>
                <div class="hidden md:block mx-auto text-gray-600"></div>
                <div class="w-full sm:w-auto mt-3 sm:mt-0 sm:ml-auto md:ml-0">
                    <form action="{{ route('Operator.Permission.index') }}">
                ...
                <table class="table table-report -mt-2 customers-list">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center whitespace-nowrap">نام دسترسی</th>
                               ...
                               <td>{{ $loop->iteration }}</td>
                                ...
                                <td class="table-report__action w-56">
                                    <div class="flex justify-center items-center">
                                        <a class="flex items-center ml-3 text-theme-1" href="{{ route('Operator.Permission.edit', ['permission' => $item]) }}"> <i data-feather="check-square" class="w-4 h-4 ml-1"></i> </a>
                                    </div>
                                </td>
                                <td class="table-report__action w-56">
                                    <form action="{{ route('Operator.Permission.destroy', ['permission' => $item]) }}" class="d-inline" method="post">
                                        @csrf
                                        @method('delete')
                                    <div class="flex justify-center items-center">
