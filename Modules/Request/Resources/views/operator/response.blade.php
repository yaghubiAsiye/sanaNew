    ...
    <div class="content">
        ...
        <div class="intro-y flex flex-col sm:flex-row items-center mt-8">
            ...
            <div class="w-full sm:w-auto flex mt-4 sm:mt-0">
                <button class="btn btn-primary shadow-md ml-2">شروع گفتگو جدید</button>
                <div class="dropdown mr-auto sm:ml-0">
                    ...
                    <div class="dropdown-menu w-40">
                        <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                            <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"> <i data-feather="users" class="w-4 h-4 ml-2"></i>ساخت گروه</a>
        ...
        <div class="intro-y chat grid grid-cols-12 gap-5 mt-5">
            ...
            <div class="col-span-12 lg:col-span-4 xxl:col-span-3">
                <div class="intro-y pr-1">
                    <div class="box p-2">
                        <div class="chat__tabs nav nav-tabs justify-center" role="tablist"> <a id="chats-tab" data-toggle="tab" data-target="#chats" href="javascript:;" class="flex-1 py-2 rounded-md text-center active" role="tab" aria-controls="chats" aria-selected="true">چت ها</a> <a id="friends-tab" data-toggle="tab" data-target="#friends" href="javascript:;" class="flex-1 py-2 rounded-md text-center" role="tab" aria-controls="friends" aria-selected="false">دوستان</a> <a id="profile-tab" data-toggle="tab" data-target="#profile" href="javascript:;" class="flex-1 py-2 rounded-md text-center" role="tab" aria-controls="profile" aria-selected="false">پروفایل</a> </div>
                    </div>
                </div>
                <div class="tab-content">
                    <div id="chats" class="tab-pane active" role="tabpanel" aria-labelledby="chats-tab">
                        <div class="pr-1">
                            <div class="box px-5 pt-5 pb-5 lg:pb-0 mt-5">
                                <div class="relative text-gray-700 dark:text-gray-300">
                                    <input type="text" class="form-control py-3 px-4 border-transparent bg-gray-200 pl-10 placeholder-theme-8" placeholder="برای جستجو پیام یا مخاطب ...">
                                    <i class="w-4 h-4 hidden sm:absolute my-auto inset-y-0 mr-3 right-0" data-feather="search"></i>
                                </div>
                                <div class="overflow-x-auto scrollbar-hidden">
                                    <div class="flex mt-5">
                                        <a href="" class="w-10 ml-4 cursor-pointer">
                                            ...
                                            <div class="text-xs text-gray-600 truncate text-center mt-2">رابرت دنیرو</div>
                                        </a>
                                        <a href="" class="w-10 ml-4 cursor-pointer">
                                            <div class="w-10 h-10 flex-none image-fit rounded-full">
                                            ...
                                            <div class="text-xs text-gray-600 truncate text-center mt-2">کوین اسپیسی</div>
                                        </a>
                                        <a href="" class="w-10 ml-4 cursor-pointer">
                                            <div class="w-10 h-10 flex-none image-fit rounded-full">
                                                <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="dist/images/profile-9.jpg">
                                                <div class="w-3 h-3 bg-theme-9 absolute left-0 bottom-0 rounded-full border-2 border-white"></div>
                                            </div>
                                            <div class="text-xs text-gray-600 truncate text-center mt-2">لئوناردو دی کاپریو</div>
                                        </a>
                                        <a href="" class="w-10 ml-4 cursor-pointer">
                                            <div class="w-10 h-10 flex-none image-fit rounded-full">
                                        ...
                                        <a href="" class="w-10 ml-4 cursor-pointer">
                                            ...
                                            <div class="text-xs text-gray-600 truncate text-center mt-2">نیکلاس کیج</div>
                                        </a>
                                        <a href="" class="w-10 ml-4 cursor-pointer">
                                            <div class="w-10 h-10 flex-none image-fit rounded-full">
                                            ...
                                            <div class="text-xs text-gray-600 truncate text-center mt-2">آل پاچینو</div>
                                        </a>
                                        <a href="" class="w-10 ml-4 cursor-pointer">
                                            <div class="w-10 h-10 flex-none image-fit rounded-full">
                                                <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="dist/images/profile-5.jpg">
                                            ...
                                            <div class="text-xs text-gray-600 truncate text-center mt-2">سیلور استالونه</div>
                                        </a>
                                        <a href="" class="w-10 ml-4 cursor-pointer">
                                            <div class="w-10 h-10 flex-none image-fit rounded-full">
                                            ...
                                            <div class="text-xs text-gray-600 truncate text-center mt-2">جانی دپ</div>
                                        </a>
                                        <a href="" class="w-10 ml-4 cursor-pointer">
                                            <div class="w-10 h-10 flex-none image-fit rounded-full">
                                            ...
                                            <div class="text-xs text-gray-600 truncate text-center mt-2">برد پیت</div>
                                        </a>
                                        <a href="" class="w-10 ml-4 cursor-pointer">
                                            <div class="w-10 h-10 flex-none image-fit rounded-full">
                        ...
                        <div class="chat__chat-list overflow-y-auto scrollbar-hidden pl-1 pt-1 mt-4">
                            <div class="intro-x cursor-pointer box relative flex items-center p-5 ">
                                ...
                                <div class="mr-2 overflow-hidden">
                                    <div class="flex items-center">
                                        <a href="javascript:;" class="font-medium">رابرت دنیرو</a>
                                        <div class="text-xs text-gray-500 mr-auto">05:09 صبح</div>
                                    </div>
                                    <div class="w-full truncate text-gray-600 mt-0.5">لورم ایپسوم در این صورت می توان امید داشت که تمام و
                            ...
                            <div class="intro-x cursor-pointer box relative flex items-center p-5 mt-5">
                                ...
                                <div class="mr-2 overflow-hidden">
                                    <div class="flex items-center">
                                        <a href="javascript:;" class="font-medium">کوین اسپیسی</a>
                                        <div class="text-xs text-gray-500 mr-auto">03:20 عصر</div>
                                    </div>
                                    <div class="w-full truncate text-gray-600 mt-0.5">لورم ایپسوم در این صورت می توان امید داشت که تمام و
                            دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز
                            شامل حروفچینی دستاوردهای ا </div>
                            ...
                            <div class="intro-x cursor-pointer box relative flex items-center p-5 mt-5">
                                ...
                                <div class="mr-2 overflow-hidden">
                                    <div class="flex items-center">
                                        <a href="javascript:;" class="font-medium">لئوناردو دی کاپریو</a>
                                        <div class="text-xs text-gray-500 mr-auto">05:09 صبح</div>
                                    </div>
                                    <div class="w-full truncate text-gray-600 mt-0.5">لورم ایپسوم در این صورت می توان امید داشت که تمام و
                            دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز
                            شامل حروفچینی دستاوردهای ا </div>
                                ...
                                <div class="w-5 h-5 flex items-center justify-center absolute top-0 left-0 text-xs text-white rounded-full bg-theme-1 font-medium -mt-1 -ml-1">2</div>
                            </div>
                            <div class="intro-x cursor-pointer box relative flex items-center p-5 mt-5">
                                <div class="w-12 h-12 flex-none image-fit ml-1">
                                    <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="dist/images/profile-15.jpg">
                                ...
                                <div class="mr-2 overflow-hidden">
                                    <div class="flex items-center">
                                        <a href="javascript:;" class="font-medium">رابرت دنیرو</a>
                                        <div class="text-xs text-gray-500 mr-auto">01:10 عصر</div>
                                    </div>
                            ...
                            متنوع با هدف بهبود ابزارهای کاربردی می باشد..</div>
                                </div>
                            </div>
                            <div class="intro-x cursor-pointer box relative flex items-center p-5 mt-5">
                                <div class="w-12 h-12 flex-none image-fit ml-1">
                                ...
                                <div class="mr-2 overflow-hidden">
                                    <div class="flex items-center">
                                        <a href="javascript:;" class="font-medium">نیکلاس کیج</a>
                                        <div class="text-xs text-gray-500 mr-auto">01:10 عصر</div>
                                    </div>
                                    <div class="w-full truncate text-gray-600 mt-0.5"> در این صورت می توان امید داشت که تمام و
                            دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز
                            ...
                            <div class="intro-x cursor-pointer box relative flex items-center p-5 mt-5">
                                ...
                                <div class="mr-2 overflow-hidden">
                                    <div class="flex items-center">
                                        <a href="javascript:;" class="font-medium">آل پاچینو</a>
                                        <div class="text-xs text-gray-500 mr-auto">01:10 عصر</div>
                                    </div>
                                    <div class="w-full truncate text-gray-600 mt-0.5"> در این صورت می توان امید داشت که تمام و
                            دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز
                            ...
                            <div class="intro-x cursor-pointer box relative flex items-center p-5 mt-5">
                                ...
                                <div class="mr-2 overflow-hidden">
                                    <div class="flex items-center">
                                        <a href="javascript:;" class="font-medium">سیلور استالونه</a>
                                        <div class="text-xs text-gray-500 mr-auto">01:10 عصر</div>
                                    </div>
                                    <div class="w-full truncate text-gray-600 mt-0.5">چاپگرها و متون بلکه روزنامه و مجله در
                            ستون و سطرآنچنان که لازم است و برای شرایط فعلی تکنولوژی مورد نیاز و کاربردهای
                            متنوع با هدف بهبود ابزارهای کاربردی می باشد..</div>
                                ...
                                <div class="w-5 h-5 flex items-center justify-center absolute top-0 left-0 text-xs text-white rounded-full bg-theme-1 font-medium -mt-1 -ml-1">6</div>
                            </div>
                            <div class="intro-x cursor-pointer box relative flex items-center p-5 mt-5">
                                <div class="w-12 h-12 flex-none image-fit ml-1">
                                    <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="dist/images/profile-3.jpg">
                                ...
                                <div class="mr-2 overflow-hidden">
                                    <div class="flex items-center">
                                        <a href="javascript:;" class="font-medium">جانی دپ</a>
                                        <div class="text-xs text-gray-500 mr-auto">05:09 صبح</div>
                                    </div>
                                    <div class="w-full truncate text-gray-600 mt-0.5"> در این صورت می توان امید داشت که تمام و
                            دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز
                            ...
                            <div class="intro-x cursor-pointer box relative flex items-center p-5 mt-5">
                                ...
                                <div class="mr-2 overflow-hidden">
                                    <div class="flex items-center">
                                        <a href="javascript:;" class="font-medium">برد پیت</a>
                                        <div class="text-xs text-gray-500 mr-auto">03:20 عصر</div>
                                    </div>
                                    <div class="w-full truncate text-gray-600 mt-0.5">لورم ایپسوم در این صورت می توان امید داشت که تمام و
                            دشواری موجود در ارائه راهکارها و شرایط سخت تایپ به پایان رسد وزمان مورد نیاز
                    ...
                    <div id="friends" class="tab-pane" role="tabpanel" aria-labelledby="friends-tab">
                        <div class="pr-1">
                            <div class="box p-5 mt-5">
                                ...
                                <button type="button" class="btn btn-primary w-full mt-3">دعوت از دوستان</button>
                            </div>
                        </div>
                        <div class="chat__user-list overflow-y-auto scrollbar-hidden pr-1 pt-1">
                            <div class="mt-4 text-gray-600">آ</div>
                            <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                                ...
                                <div class="mr-2 overflow-hidden">
                                    <div class="flex items-center"> <a href="" class="font-medium">رابرت دنیرو</a> </div>
                                    <div class="w-full truncate text-gray-600 mt-0.5">آخرین بازدید2 ساعت قبل</div>
                                </div>
                                <div class="dropdown mr-auto">
                                    ...
                                    <div class="dropdown-menu w-40">
                                        <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                                            <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"> <i data-feather="share-2" class="w-4 h-4 ml-2"></i> اشتراک مخاطب </a>
                                            <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"> <i data-feather="copy" class="w-4 h-4 ml-2"></i>کپی مخاطب</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                                ...
                                <div class="mr-2 overflow-hidden">
                                    <div class="flex items-center"> <a href="" class="font-medium">کوین اسپیسی</a> </div>
                                    <div class="w-full truncate text-gray-600 mt-0.5">آخرین بازدید2 ساعت قبل</div>
                                </div>
                                <div class="dropdown mr-auto">
                                    <a class="dropdown-toggle w-5 h-5 block" href="javascript:;" aria-expanded="false"> <i data-feather="more-horizontal" class="w-5 h-5 text-gray-600 dark:text-gray-300"></i> </a>
                            ...
                            <div class="mt-4 text-gray-600">ب</div>
                            <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                                <div class="w-12 h-12 flex-none image-fit ml-1">
                                    <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="dist/images/profile-9.jpg">
                                    <div class="w-3 h-3 bg-theme-9 absolute left-0 bottom-0 rounded-full border-2 border-white"></div>
                                ...
                                <div class="mr-2 overflow-hidden">
                                    <div class="flex items-center"> <a href="" class="font-medium">لئوناردو دی کاپریو</a> </div>
                                    <div class="w-full truncate text-gray-600 mt-0.5">آخرین بازدید2 ساعت قبل</div>
                                </div>
                                <div class="dropdown mr-auto">
                                    <a class="dropdown-toggle w-5 h-5 block" href="javascript:;" aria-expanded="false"> <i data-feather="more-horizontal" class="w-5 h-5 text-gray-600 dark:text-gray-300"></i> </a>
                            ...
                            <div class="cursor-pointer box relative flex items-center p-5 mt-5">
                                ...
                                <div class="mr-2 overflow-hidden">
                                    <div class="flex items-center"> <a href="" class="font-medium">نیکلاس کیج</a> </div>
                                    <div class="w-full truncate text-gray-600 mt-0.5">آخرین بازدید2 ساعت قبل</div>
                                </div>
                                <div class="dropdown mr-auto">
                        ...
                        <div class="pr-1">
                            <div class="box px-5 py-10 mt-5">
                                ...
                                <div class="text-center mt-3">
                                    <div class="font-medium text-lg">رابرت دنیرو</div>
                                    <div class="text-gray-600 mt-1">قالب مدیریتی اچ تی ام ال</div>
                                </div>
                            </div>
                            <div class="box p-5 mt-5">
                                <div class="flex items-center border-b border-gray-200 dark:border-dark-5 pb-5">
                                    <div>
                                        ...
                                        <div class="mt-1">نیویورک ، آمریکا</div>
                                    </div>
                                    <i data-feather="globe" class="w-4 h-4 text-gray-600 mr-auto"></i>
                                </div>
                                <div class="flex items-center border-b border-gray-200 dark:border-dark-5 py-5">
                                    <div>
                                        <div class="text-gray-600">شماره</div>
                                        <div class="mt-1">+32 19 23 62 24 34</div>
                                    </div>
                                    <i data-feather="mic" class="w-4 h-4 text-gray-600 mr-auto"></i>
                                </div>
                                <div class="flex items-center border-b border-gray-200 dark:border-dark-5 py-5">
                                    <div>
                                        <div class="text-gray-600">ایمیل</div>
                                        <div class="mt-1">robertdeniro@left4code.com</div>
                                    </div>
                                    <i data-feather="mail" class="w-4 h-4 text-gray-600 mr-auto"></i>
                                </div>
                                <div class="flex items-center pt-5">
                                    <div>
                                        <div class="text-gray-600">تاریخ عضویت</div>
                                        <div class="mt-1">12 مهر 1400</div>
                                    </div>
                                    <i data-feather="clock" class="w-4 h-4 text-gray-600 mr-auto"></i>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="chat__box box">
                    ...
                    <div class="hidden h-full flex flex-col">
                        <div class="flex flex-col sm:flex-row border-b border-gray-200 dark:border-dark-5 px-5 py-4">
                            <div class="flex items-center">
                                ...
                                <div class="mr-3 ml-auto">
                                    <div class="font-medium text-base">رابرت دنیرو</div>
                                    <div class="text-gray-600 text-xs sm:text-sm">سلام من از چت استفاده میکنم <span class="mx-1">•</span> آنلاین </div>
                                </div>
                            </div>
                            <div class="flex items-center sm:mr-auto mt-5 sm:mt-0 border-t sm:border-0 border-gray-200 pt-3 sm:pt-0 -mx-5 sm:mx-0 px-5 sm:px-0">
                                <a href="javascript:;" class="w-5 h-5 text-gray-600"> <i data-feather="search" class="w-5 h-5"></i> </a>
                                <a href="javascript:;" class="w-5 h-5 text-gray-600 mr-4"> <i data-feather="user-plus" class="w-5 h-5"></i> </a>
                                <div class="dropdown mr-auto sm:mr-3">
                        ...
                        <div class="overflow-y-scroll scrollbar-hidden px-5 pt-5 flex-1">
                            <div class="chat__box__text-box flex items-end float-right mb-4">
                                ...
                                <div class="bg-gray-200 dark:bg-dark-5 px-4 py-3 text-gray-700 dark:text-gray-300 rounded-r-md rounded-t-md">
                                    ...
                                    <div class="mt-1 text-xs text-gray-600">2 دقیقه قبل</div>
                                </div>
                                <div class="hidden sm:block dropdown mr-3 my-auto">
                                    ...
                                    <div class="dropdown-menu w-40">
                                        <div class="dropdown-menu__content box dark:bg-dark-1 p-2">
                                            <a href="" class="flex items-center block p-2 transition duration-300 ease-in-out bg-white dark:bg-dark-1 hover:bg-gray-200 dark:hover:bg-dark-2 rounded-md"> <i data-feather="corner-up-left" class="w-4 h-4 ml-2"></i> پاسخ </a>
                            ...
                            <div class="chat__box__text-box flex items-end float-left mb-4">
                                ...
                                <div class="bg-theme-1 px-4 py-3 text-white rounded-l-md rounded-t-md">
                                    شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو
                                    <div class="mt-1 text-xs text-theme-33">1 دقیقه قبل</div>
                                </div>
                            ...
                            <div class="chat__box__text-box flex items-end float-left mb-4">
                                ...
                                <div class="bg-theme-1 px-4 py-3 text-white rounded-l-md rounded-t-md">
                                    شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو
                                    <div class="mt-1 text-xs text-theme-33">59 ثانیه قبل</div>
                                </div>
                                <div class="w-10 h-10 hidden sm:block flex-none image-fit relative mr-5">
                                    <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="dist/images/profile-12.jpg">
                                </div>
                            ...
                            <div class="clear-both"></div>
                            <div class="text-gray-500 dark:text-gray-600 text-xs text-center mb-10 mt-5">12 مهر 1400</div>
                            <div class="chat__box__text-box flex items-end float-right mb-4">
                                <div class="w-10 h-10 hidden sm:block flex-none image-fit relative ml-5">
                                    <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="dist/images/profile-5.jpg">
                                </div>
                                <div class="bg-gray-200 dark:bg-dark-5 px-4 py-3 text-gray-700 dark:text-gray-300 rounded-r-md rounded-t-md">
                                    شناخت بیشتری را برای طراحان رایانه ای علی الخصوص طراحان خلاقی و فرهنگ پیشرو
                                    <div class="mt-1 text-xs text-gray-600">10 ثانیه قبل</div>
                                </div>
                                <div class="hidden sm:block dropdown mr-3 my-auto">
                                    <a href="javascript:;" class="dropdown-toggle w-4 h-4 text-gray-600" aria-expanded="false"> <i data-feather="more-vertical" class="w-4 h-4"></i> </a>
                                    <div class="dropdown-menu w-40">
                            ...
                            <div class="chat__box__text-box flex items-end float-left mb-4">
                                ...
                                <div class="bg-theme-1 px-4 py-3 text-white rounded-l-md rounded-t-md">
                                    لورم ایپسوم
                                    <div class="mt-1 text-xs text-theme-33">1 ثانیه قبل</div>
                                </div>
                                <div class="w-10 h-10 hidden sm:block flex-none image-fit relative mr-5">
                                    <img alt="Icewall Tailwind HTML Admin Template" class="rounded-full" src="dist/images/profile-12.jpg">
                                </div>
                        ...
                        <div class="pt-4 pb-10 sm:py-4 flex items-center border-t border-gray-200 dark:border-dark-5">
                            <textarea class="chat__box__input form-control dark:bg-dark-3 h-16 resize-none border-transparent px-5 py-3 shadow-none focus:ring-0" rows="1" placeholder="پیام خود را تایپ کنید..."></textarea>
                            <div class="flex absolute sm:static left-0 bottom-0 ml-5 sm:ml-0 mb-5 sm:mb-0">
                                <div class="dropdown ml-3 sm:ml-5">
                                    ...
                                    <div class="chat-dropdown dropdown-menu">
                                        <div class="dropdown-menu__content">
                                            <div class="chat-dropdown__box box dark:bg-dark-1 flex flex-col pb-3 -mt-2">
                                                <div class="px-3 pt-3">
                                                    <div class="relative text-gray-700 dark:text-gray-300">
                                                        <input type="text" class="form-control border-transparent bg-gray-200 pr-10 placeholder-theme-8" placeholder="جستجو ایموجی...">
                                                ...
                                                <div class="tab-content overflow-hidden mt-5">
                                                    <div id="history" class="h-full tab-pane" role="tabpanel" aria-labelledby="history-tab">
                                                        <div class="font-medium px-3">آخرین ایموجی ها</div>
                                                    ...
                                                    <div id="smile" class="h-full tab-pane active" role="tabpanel" aria-labelledby="smile-tab">
                                                        <div class="font-medium px-3">مردم و لبخند</div>
                                                        <div class="h-full pb-10 px-2 overflow-y-auto scrollbar-hidden mt-2">
                                                            <div class="grid grid-cols-8 text-2xl">
                                                                <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">😀</button>
                                                                <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">😁</button>
                                                    ...
                                                    <div id="cat" class="h-full tab-pane" role="tabpanel" aria-labelledby="cat-tab">
                                                        <div class="font-medium px-3">حیوانات و طبیعت</div>
                                                        <div class="h-full pb-10 px-2 overflow-y-auto scrollbar-hidden mt-2">
                                                            <div class="grid grid-cols-8 text-2xl">
                                                                <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🐵</button>
                                                                <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🐒</button>
                                                    ...
                                                    <div id="coffee" class="h-full tab-pane" role="tabpanel" aria-labelledby="coffee-tab">
                                                        <div class="font-medium px-3">نوشیدنی و خوراک</div>
                                                        <div class="h-full pb-10 px-2 overflow-y-auto scrollbar-hidden mt-2">
                                                            <div class="grid grid-cols-8 text-2xl">
                                                                <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🍇</button>
                                                                <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🍈</button>
                                                    ...
                                                    <div id="futbol" class="h-full tab-pane" role="tabpanel" aria-labelledby="futbol-tab">
                                                        <div class="font-medium px-3">فعالیت ها</div>
                                                        <div class="h-full pb-10 px-2 overflow-y-auto scrollbar-hidden mt-2">
                                                            <div class="grid grid-cols-8 text-2xl">
                                                                <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🎃</button>
                                                                <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🎄</button>
                                                    ...
                                                    <div id="building" class="h-full tab-pane" role="tabpanel" aria-labelledby="building-tab">
                                                        <div class="font-medium px-3">سفر و مکان ها</div>
                                                        <div class="h-full pb-10 px-2 overflow-y-auto scrollbar-hidden mt-2">
                                                            <div class="grid grid-cols-8 text-2xl">
                                                                <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🌍</button>
                                                                <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🌎</button>
                                                    ...
                                                    <div id="lightbulb" class="h-full tab-pane" role="tabpanel" aria-labelledby="lightbulb-tab">
                                                        <div class="font-medium px-3">اشیا</div>
                                                        <div class="h-full pb-10 px-2 overflow-y-auto scrollbar-hidden mt-2">
                                                            <div class="grid grid-cols-8 text-2xl">
                                                                <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🔇</button>
                                                                <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🔈</button>
                                                    ...
                                                    <div id="music" class="h-full tab-pane" role="tabpanel" aria-labelledby="music-tab">
                                                        <div class="font-medium px-3">سمبل ها</div>
                                                        <div class="h-full pb-10 px-2 overflow-y-auto scrollbar-hidden mt-2">
                                                            <div class="grid grid-cols-8 text-2xl">
                                                                <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🏧</button>
                                                                <button class="rounded focus:outline-none hover:bg-gray-200 dark:hover:bg-dark-2">🚮</button>
                                ...
                                <div class="w-4 h-4 sm:w-5 sm:h-5 relative text-gray-600 ml-3 sm:ml-5">
                                    <i data-feather="paperclip" class="w-full h-full"></i>
                                    <input type="file" class="w-full h-full top-0 left-0 absolute opacity-0">
                                </div>
                            </div>
                            <a href="javascript:;" class="w-8 h-8 sm:w-10 sm:h-10 block bg-theme-1 text-white rounded-full flex-none flex items-center justify-center ml-5"> <i data-feather="send" class="w-4 h-4"></i> </a>
                        </div>
                    </div>
                    <!-- END: Chat Active -->
                    <!-- BEGIN: Chat Default -->
                    <div class="h-full flex items-center">
                        <div class="mx-auto text-center">
                            ...
                            <div class="mt-3">
                                <div class="font-medium">سلام , رابرت د نیرو!</div>
                                <div class="text-gray-600 mt-1">لطفا یک چت را انتخاب کن</div>
                            </div>
                        </div>
                    </div>
                    <!-- END: Chat Default -->
