...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Modules\Request\Http\Controllers';
    ...
    protected function mapEmployeeRoutes()
    {
        Route::middleware('web')
            ...
            ->prefix('Employee')
            ->group(module_path('Request', '/Routes/v1/employee.php'));
    }
    ...
    protected function mapOperatorRoutes()
    {
        Route::middleware('web')
            ...
            ->prefix('Operator')
            ->group(module_path('Request', '/Routes/v1/operator.php'));
    }
    ...
    protected function mapApiRoutes()
    {
        Route::prefix('api')
            ...
            ->group(module_path('Request', '/Routes/api.php'));
    }
}
