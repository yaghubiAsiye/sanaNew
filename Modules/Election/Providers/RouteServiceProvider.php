...
class RouteServiceProvider extends ServiceProvider
{
     ...
     * @var string
     */
    protected $moduleNamespace = 'Modules\Election\Http\Controllers';
    ...
    protected function mapEmployeeRoutes()
    {
        Route::middleware('web')
            ...
            ->prefix('Employee')
            ->group(module_path('Election', '/Routes/v1/employee.php'));
    }
    ...
    protected function mapOperatorRoutes()
    {
        Route::middleware('web')
            ...
            ->prefix('Operator')
            ->group(module_path('Election', '/Routes/v1/operator.php'));
    }
