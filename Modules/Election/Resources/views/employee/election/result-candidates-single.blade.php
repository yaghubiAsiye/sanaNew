...
<div class="flex">
    ...
    <div class="content">
        <!-- BEGIN: Top Bar -->
        @include('partials.topBarSide', ['breadcrumb'=> [' لیست  رای دهنگان']])
        <!-- END: Top Bar -->
        <h2 class="intro-y text-lg font-medium mt-10">
            لیست  رای دهنگان به {{ $Candidate->user->first_name . ' ' . $Candidate->user->last_name}}
        </h2>
                   ...
                   <div class="preview">
                       <div class="overflow-x-auto">
                           <table class="table table-report -mt-2">
                               ...
                               <tbody>
                                    @foreach ($Candidate->elections as $item)
                                        <tr class="intro-x">
                                            ...
                                            {{-- <td class="text-center">
                                                <a  href="{{ route('') }}" target="_blank" class="btn btn-primary-soft mr-1 mb-2">
